...
final historyRangesProvider = FutureProvider<HistoryRangesResponseModel>((
  ref,
) async {
...
final overviewHistoryProvider =
    FutureProvider.family<
      CachedHistoryData<HistoryOverviewResponseModel>,
      HistoryRangeValue
    >((ref, range) async {
